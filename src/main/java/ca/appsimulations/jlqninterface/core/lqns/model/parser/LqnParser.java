...
import ca.appsimulations.jlqninterface.core.lqns.entities.ActivityDefBase;
...
import ca.appsimulations.jlqninterface.core.lqns.entities.TaskActivities;
...
public abstract class LqnParser extends DefaultHandler {
    ...
    public void printProcessors() {
        int size = lqnModel.getProcessorsSize();
        for (int i = 0; i < size; i++) {
            logger.info(lqnModel.getProcessorAtIndex(i).toString());
        }
    }
    ...
    public String getLQXCData(boolean addCData) {
        ...
        if (addCData) {
            ...
            cData.append(lqnModel.getProcessorsCDataString() + "\n\n");
            cData.append(lqnModel.getTasksCDataString() + "\n\n");
            cData.append(lqnModel.getBelowCDataString() + "\n\n");
