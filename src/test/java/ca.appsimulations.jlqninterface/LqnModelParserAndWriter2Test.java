...
public class LqnModelParserAndWriter2Test {

    private File outputFile;
    private SoftAssertions softly;
    private final String LQN_XSD = "lqn.xsd";
    private final String INPUT_LQNX = "input-replication.lqnx";
    ...
    public void testParserAndWriter() throws Exception {
        ...
        //assertXmlAgainstSchema(getResourceFile(INPUT_LQNX).getAbsolutePath(), LQN_XSD);
