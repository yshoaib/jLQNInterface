...
public enum ProcessorSchedulingType {
	...
	PS("ps"), // Processor sharing. The processor runs all tasks
	...
	RAND("rand"), // Random scheduling. The processor selects a task at random.
	CFS("cfs"), // Completely fair scheduling [9]. Tasks are scheduled within
